...
export class CountOfExchangedCardsComponent implements  OnInit{
  ...
  constructor(private http: HttpClient,
   ...
   ngOnInit() {
      ...
      this.generateToken();   
      this.Encrypt();
      const encrypted = this.TokenService.EncryptedData(JSON.stringify(this.CountofExchangedCards));
  ...
  Encrypt() {
      ...
      console.log(this.CountofExchangedCards);
      var encrypted = CryptoJS.AES.encrypt(JSON.stringify(this.CountofExchangedCards), key128Bits1000Iterations, 
        { 
